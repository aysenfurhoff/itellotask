...
public final class PaymentFileHandlerInbetalningstjansten extends PaymentFileHandler{
    ...
    private final static Date paymentDate = null;    
    //Filformatet saknar denna information.
    private final static String currency = "SEK";    
    //Enligt beskrivning av filformatet.
        ...
        for(String dataRow : dataRows) {
            ...
            switch(postType) {
                ...
                //case ENDING_POST:
                    ...
                    //Man kan lägga till kontroll totalbelopp här
            }
        }
    }
